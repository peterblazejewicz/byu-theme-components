...
(function () {
    ...
    /***/function (module, __webpack_exports__, __webpack_require__) {
        ...
        var BYUFooter = function (_HTMLElement3) {
            ...
            _createClass(BYUFooter, [{
                ...
                value: function connectedCallback() {
                    var component = this;
                    __WEBPACK_IMPORTED_MODULE_1_byu_web_component_utils__["applyTemplate"](component, 'byu-footer', __WEBPACK_IMPORTED_MODULE_0__template_html__, function () {
    ...
    /***/function (module, exports, __webpack_require__) {
        ...
        // module
        exports.push([module.i, ":host{padding:0 15px;box-sizing:border-box;float:left}@media screen and (max-width:767px){:host{width:100%}}@media screen and (min-width:768px) and (max-width:1023px){:host{width:50%}}@media screen and (min-width:1024px){:host{width:25%}}.header{width:100%}.header ::slotted(*){font-family:Vitesse A,Vitesse B,Georgia,serif!important;text-transform:uppercase!important;color:#002e5d!important;font-size:20px!important;border-bottom:1px solid #c5c5c5!important;padding-bottom:3px!important;margin-bottom:5px!important;white-space:nowrap!important;font-weight:400!important;width:100%;display:inline-block}.content ::slotted(:not(byu-footer-action-button)){font-family:Gotham A,Gotham B,Helvetica,sans-serif!important;font-size:13px;font-weight:400;color:#767676!important;position:relative;top:-11px;line-height:1.42857143}.content ::slotted(a){line-height:35px;text-decoration:none!important;outline:none!important}.content ::slotted(a:hover){cursor:pointer;color:#002e5d!important}", ""]);
    ...
    /***/function (module, exports, __webpack_require__) {
        ...
        // module
        exports.push([module.i, ".blue-footer{background-color:#002e5d;text-align:center;font-family:Gotham A,Gotham B,Helvetica,sans-serif;font-weight:400;font-size:12px;color:#fff;height:80px;width:100%;display:flex;justify-content:center;align-items:center}.blue-footer a{text-decoration:none;color:#fff}.blue-footer a:hover{color:#fff}.inner-wrapper{max-width:1200px;margin-top:-10px}.university-logo{width:450px;max-width:100vw;box-sizing:border-box;margin-bottom:-10px;height:40px}.secondary-footer{height:auto;background-color:#e5e5e5;text-align:center;display:flex;justify-content:center;flex:1}.secondary-footer ::slotted(*){display:inline-block;text-align:left;vertical-align:top}.secondary-footer-content{margin:0 15px}@media screen and (min-width:1200px){.secondary-footer-content{width:1200px!important}}:host([full-width]) .inner-wrapper{max-width:100%}:host([full-width]) .secondary-footer-content{width:100%}@media (max-width:767px){.secondary-footer,.secondary-footer ::slotted(*){width:100%}.secondary-footer ::slotted(:last-child){padding-bottom:30px}.secondary-footer ::slotted(:first-child){padding-top:10px}.secondary-footer ::slotted(*){padding-left:0!important;padding-right:0!important}}@media (min-width:768px) and (max-width:1199px){.secondary-footer{width:100%}.secondary-footer-content ::slotted(*){width:50%}.secondary-footer ::slotted(:nth-child(n+3)){padding-bottom:30px}.secondary-footer ::slotted(:nth-child(-n+2)){padding-top:10px}.secondary-footer ::slotted(:nth-child(odd)){padding-left:0!important}.secondary-footer ::slotted(:nth-child(2n)){padding-right:0!important}}@media (min-width:1200px){.secondary-footer ::slotted(*){width:25%;padding-top:10px;padding-bottom:30px}.secondary-footer ::slotted(:first-child){padding-left:0!important}.secondary-footer ::slotted(:last-child){padding-right:0!important}}", ""]);
    ...
    /***/function (module, exports, __webpack_require__) {
        ...
        module.exports = "<style>" + __webpack_require__(14) + "</style> <div class=\"secondary-footer\"> <div class=\"secondary-footer-content\"> <slot id=\"slot\"></slot> </div> </div> <div class=\"blue-footer\"> <div class=\"inner-wrapper\"> <a href=\"https://home.byu.edu/home/\" target=\"_blank\"><img src=\"" + __webpack_require__(32) + "\" alt=\"Brigham Young University\" class=\"university-logo\"></a> <div class=\"copyright-contact\">&copy; <span id=\"currentYear\"></span> All Rights Reserved | Provo, UT 84602, USA | <a href=\"tel:18014224636\">801-422-4636</a></div> </div> </div>";
